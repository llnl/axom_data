...
| Filename | Additional Notes |
| -------- | ---------------- |
| biquartic_sphere_surface.step | Derived with formulas in [Cobb 1988](https://collections.lib.utah.edu/ark:/87278/s61g14n6) |
| teardrop.step | |
...
| utah_teapot.step | Data from an archive of [Utah teapot models](https://users.cs.utah.edu/%7Edejohnso/models/teapot.html), regenerated as a STEP file. |